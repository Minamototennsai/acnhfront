      ...
      <div>
        ...
        <div v-if="materialslist.length && materials.length">
          ...
          <ul class="materials-list">
            <li v-for="accessories in materialslist" :key="accessories.id" class="materials-item">
              <p>{{ accessories.name }} : {{ accessories.numberOfMaterial1 }} {{ accessories.material1 }} {{ accessories.numberOfMaterial2 }} {{ accessories.material2 }} {{ accessories.numberOfMaterial3 }} {{ accessories.material3 }} {{ accessories.numberOfMaterial4 }} {{ accessories.material4 }} {{ accessories.numberOfMaterial5 }} {{ accessories.material5 }} {{ accessories.numberOfMaterial6 }} {{ accessories.material6 }}</p >
            </li>
          </ul>
        </div>
        ...
        <el-table-column prop="type" label="Type">
          <template #header>
            <div>
              ...
              <el-option label="Null" value=""></el-option>
              <el-option label="AccessoryEye" value="AccessoryEye"></el-option>        
              <el-option label="AccessoryMouth" value="AccessoryMouth"></el-option>        
              <el-option label="AccessoryMouthInvisibleNose" value="AccessoryMouthInvisibleNose"></el-option>        
              <el-option label="AcceEyeMouth" value="AcceEyeMouth"></el-option>        
              <el-option label="AccessoryEyeMouthInvisibleNose" value="AccessoryEyeMouthInvisibleNose"></el-option>        
              <el-option label="AccessoryMouthEarJaw" value="AccessoryMouthEarJaw"></el-option>        
              <el-option label="AccessoryOneEye" value="AccessoryOneEye"></el-option>        
            </el-select>
            </div>
          </template>
          <template #default="{ row }">
  ...
  setup() {
    ...
    const findMaterials = async () => {
      ...
      try {
        ...
        const response = await axios.get('/api/accessories/materials', { params });
    ...
    // 组件创建时从/api/accessories接口获取初始数据
    onMounted(() => {
      fetchAllData();
    });
    
    // 从/api/accessories接口获取初始数据
    const fetchAllData = () => {
    ...
    // 从/api/accessories/{id}接口获取搜索数据
    const fetchDataFromApiGetById = (query) => {
      axios.get(`/api/accessories/${query}`).then(response => {
        tableData.value = [response.data];
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/findByName接口获取搜索数据
    const fetchDataFromApiFindByName = (query) => {
      axios.get(`/api/accessories/findByName?name=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchVariation接口获取搜索数据
    const fetchDataFromApiSearchVariation = (query) => {
      axios.get(`/api/accessories/searchVariation?variation=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchDiy接口获取搜索数据
    const fetchDataFromApiSearchDiy = (query) => {
      axios.get(`/api/accessories/searchDiy?diy=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchBuy接口获取搜索数据
    const fetchDataFromApiSearchBuy = (min, max, sort) => {
      axios.get(`/api/accessories/searchBuy?min=${min}&max=${max}&sort=${sort}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length;
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchSell接口获取搜索数据
    const fetchDataFromApiSearchSell = (min, max, sort) => {
      axios.get(`/api/accessories/searchSell?min=${min}&max=${max}&sort=${sort}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length;
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchColor1接口获取搜索数据
    const fetchDataFromApiSearchColor1 = (query) => {
      axios.get(`/api/accessories/searchColor1?color1=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchColor2接口获取搜索数据
    const fetchDataFromApiSearchColor2 = (query) => {
      axios.get(`/api/accessories/searchColor2?color2=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchMilesPrice接口获取搜索数据
    const fetchDataFromApiSearchMilesPrice = (min, max, sort) => {
      axios.get(`/api/accessories/searchMilesPrice?min=${min}&max=${max}&sort=${sort}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length;
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchSource接口获取搜索数据
    const fetchDataFromApiSearchSource = (query) => {
      axios.get(`/api/accessories/searchSource?source=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchSeasonalAvailability接口获取搜索数据
    const fetchDataFromApiSearchSeasonalAvailability = (query) => {
      axios.get(`/api/accessories/searchSeasonalAvailability?seasonalAvailability=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchMannequinPiece接口获取搜索数据
    const fetchDataFromApiSearchMannequinPiece = (query) => {
      axios.get(`/api/accessories/searchMannequinPiece?mannequinPiece=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchStyle接口获取搜索数据
    const fetchDataFromApiSearchStyle = (query) => {
      axios.get(`/api/accessories/searchStyle?style=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchLabelThemes接口获取搜索数据
    const fetchDataFromApiSearchLabelThemes = (query) => {
      axios.get(`/api/accessories/searchLabelThemes?labelThemes=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchType接口获取搜索数据
    const fetchDataFromApiSearchType = (query) => {
      axios.get(`/api/accessories/searchType?type=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchVillagerEquippable接口获取搜索数据
    const fetchDataFromApiSearchVillagerEquippable = (query) => {
      axios.get(`/api/accessories/searchVillagerEquippable?villagerEquippable=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
    ...
    // 从/api/accessories/searchCatalog接口获取搜索数据
    const fetchDataFromApiSearchCatalog = (query) => {
      axios.get(`/api/accessories/searchCatalog?catalog=${query}`).then(response => {
        tableData.value = response.data;
        total.value = tableData.value.length; 
        currentPage.value = 1; 
      });
