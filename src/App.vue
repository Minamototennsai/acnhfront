...
export default {  
  ...
  data() {  
    return {  
      ...
      { text: 'Constructions', imgSrc: require('@/assets/construction.png'), route: '/component6' },
      { text: 'DressUp', imgSrc: require('@/assets/Dress-Up.png'), route: '/component7' },
      ...
      { text: 'WallMounted', imgSrc: require('@/assets/wall-mounted.png'), route: '/component29' },
  ...
  computed: {
    buttonRows() {
      const rows = [];
      const buttonsPerPage = 3; // 每行显示的按钮数
...
button {  
  /* 设置按钮的基本样式 */  
  display: block; /* 使其占据容器的整行 */  
  width: 100%; /* 根据容器宽度自动调整按钮宽度 */  
